...
.controller('loginCtrl', function($scope , sharedConn,$state,$cordovaDevice ) {
	console.log("app.js Log: ");
	

	var XMPP_DOMAIN  = 'chat.spotchat.in'; // Domain we are going to be connected to.
	var xmpp_user    = 'test1';     // xmpp user name
	var xmpp_pass    = '1q2w3e$R';
